                    ...
                    <div class="card-body">
                        <form action="/budaya/update/{{ $budaya->id_budaya }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $budaya->nama_budaya }}"
                                    @error('nama_budaya') is invalid @enderror id="nama_budaya" name="nama_budaya" required>
                                @error('nama_budaya')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $budaya->pengelola }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $budaya->kategori }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" value="{{ $budaya->foto }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $budaya->htm }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $budaya->latitude }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $budaya->longitude }}"
