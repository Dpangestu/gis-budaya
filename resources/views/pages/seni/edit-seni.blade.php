                            ...
                            <div class="card-body">
                                <form action="/seni/update/{{ $seni->id_seni }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" value="{{ $seni->deskripsi }}" @error('deskripsi') is invalid @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="foto">Nama Seni</label>
                                        <input class="form-control" type="file" value="{{ $seni->foto }}"
