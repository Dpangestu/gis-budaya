                                ...
                                <form action="/pengajuan/store" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('nama_data') }}"
                                            @error('nama_data') is invalid @enderror id="nama_data" name="nama_data"
                                            required>
                                        @error('nama_data')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" id="formFile"
                                            value="{{ old('foto') }}" @error('foto') is invalid @enderror id="foto"
                                            name="foto" required>
                                        @error('foto')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="card-footer ">
                                        <button href="/pengajuan" class="btn btn-secondary"
