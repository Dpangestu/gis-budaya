...
<head>
    ...
    <title>GIS Seni Budaya | Selamat Datang</title>
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center header-transparent">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                <h1><a href="index.html"><span>GIS Seni Budaya</span></a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#about">Seni</a></li>
                    <li><a class="nav-link scrollto" href="#features">Budaya</a></li>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                    <div data-aos="zoom-out">
                        <h1>Sistem Informasi Geografis<span> Seni Budaya</span></h1>
                        <h2>Sistem pemetaan untuk Situs Seni Budaya di Kabupaten Cirebon</h2>
                        <div class="text-center text-lg-start">
                            <a href="#map" class="btn-get-started scrollto">Mulai</a>
                        </div>
                    </div>
                </div>
    ...
    <footer id="footer">
        <div class="container">
            <div class="copyright">
                <strong>Copyright &copy; 2023 <a href="https://adminlte.io">{{ config('app.name') }}</a>.</strong>
                All rights reserved.
            </div>
            <div class="credits">
